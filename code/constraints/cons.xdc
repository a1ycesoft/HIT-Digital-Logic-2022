...
set_property IOSTANDARD LVCMOS33 [get_ports inputpwd]
set_property IOSTANDARD LVCMOS33 [get_ports left_pos]
...
#右1LED，灯亮表示锁处于打开状态
set_property PACKAGE_PIN G4 [get_ports open] 
...
set_property PACKAGE_PIN P4 [get_ports inputpwd] 

#左4数码管位选，用于显示倒计时
set_property PACKAGE_PIN G2 [get_ports {left_pos[0]}]
set_property PACKAGE_PIN C2 [get_ports {left_pos[1]}]
set_property PACKAGE_PIN C1 [get_ports {left_pos[2]}]
set_property PACKAGE_PIN H1 [get_ports {left_pos[3]}]

#右侧四个拨码开关，模拟上升沿用于给对应数码+1
set_property PACKAGE_PIN V1 [get_ports clk3]
set_property PACKAGE_PIN R15 [get_ports clk2]
set_property PACKAGE_PIN R11 [get_ports clk1]
set_property PACKAGE_PIN R17 [get_ports clk0]
